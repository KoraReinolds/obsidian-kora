...
export class ConfigModal<T = any> extends Modal {
  ...
  onOpen() {
    ...
    const saveBtn = buttonContainer.createEl('button', { text: 'Сохранить', cls: 'mod-cta' });
    saveBtn.onclick = () => {
  ...
  private createFieldSetting(field: FieldConfig) {
    ...
    switch (field.type) {
      ...
      case 'command':
        ...
        const commandName = currentCommandId ? this.getCommandName(currentCommandId) : 'Команда не выбрана';
