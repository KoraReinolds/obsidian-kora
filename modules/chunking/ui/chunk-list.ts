 ...
 */
export function renderChunkList(container: HTMLElement, chunks: Chunk[], _options: ChunkListOptions = {}): ChunkListRefs {
  ...
  for (const c of chunks) {
    ...
    const left = top.createEl('span'); left.textContent = `${c.chunkType} — ${c.headingsPath.join(' > ')}`;
